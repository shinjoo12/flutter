...
* 한번 생성되면 변경되지 않는 위젯이다. 또한 자체적으로 상태 관리를 하지 않는 것을 의미힌다.
* */
class MainApp extends StatelessWidget {
  // 클래스 생성자는 super.key를 사용하여 부모 클래스인 StatelessWidget의 생성자를 호출한다.
  /*
  * super.key는 이 위젯의 키를 설정하며 키는 flutter 위젯의 고유하게 식별하는 데 사용된다.
  ...
  * ui 정의 : build 메서드는 반환된 위젯 트리를 기반으로 화면에 표시될 ui를 정의한다. 다양한 위젯ㅇ늘 조합하여 원하는 레이아웃과 스타일 정의가 가능하다.
  ...
  * */
  ...
  Widget build(BuildContext context) {
    ...
    * theme : 앱의 기본 테마를 정의힌다. 색상, 텍스트, 스타일 및 기타 스타일 속성 설정이 가능한다.
